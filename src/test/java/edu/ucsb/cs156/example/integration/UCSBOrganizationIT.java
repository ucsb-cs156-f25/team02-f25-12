  ...
  public void an_admin_user_can_post_a_new_ucsborganization() throws Exception {
    ...
    UCSBOrganization organization1 =
        UCSBOrganization.builder()
            ...
            .orgTranslation("Association of Computerized Machinery")
            .inactive(false)
            .build();
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/ucsborganization/post?orgCode=ACM&orgTranslationShort=ACM&orgTranslation=Association of Computerized Machinery&inactive=false")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
