...
public class MenuItemReviewWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_menuitemreview() throws Exception {
    ...
    page.getByTestId("MenuItemReviewForm-itemId").fill("56");
    page.getByTestId("MenuItemReviewForm-reviewerEmail").fill("user@ucsb.edu");
    page.getByTestId("MenuItemReviewForm-stars").fill("3");
    page.getByTestId("MenuItemReviewForm-dateReviewed").fill("2022-01-03T01:02");
    page.getByTestId("MenuItemReviewForm-comments").fill("it was okay");
    page.getByTestId("MenuItemReviewForm-submit").click();

    assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-itemId")).hasText("56");
    ...
    assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-stars")).hasText("2");

    page.getByTestId("MenuItemReviewTable-cell-row-0-col-Delete-button").click();

    assertThat(page.getByTestId("MenuItemReviewTable-cell-row-0-col-stars")).not().isVisible();
  }
