...
describe("MenuItemReviewIndexPage tests", () => {
  ...
  test("renders three menuitemreviews correctly for regular user", async () => {
    ...
    const reviewerEmail = screen.getByText("JackL@ucsb.edu");
    expect(reviewerEmail).toBeInTheDocument();

    const stars = screen.getByText("Stars");
    expect(stars).toBeInTheDocument();

    const dateReviewed = screen.getByText("2025-10-26T12:00:00");
    expect(dateReviewed).toBeInTheDocument();

    const comments = screen.getByText("It was average");
